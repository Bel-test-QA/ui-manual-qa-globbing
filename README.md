...
<h6>Для корректного отображения проектной документации, сохранения интерактивности ссылок и просмотра видеозаписей баг-репортов (в разделе Attachments), ознакомьтесь с проектом одним из удобных способов:</h6>

### Вариант 1. Быстрый просмотр (без установки Git)
...
### Вариант 2. Полное клонирование проекта (через Git)
...
3. Откройте необходимый файл через любой PDF-ридер для полноценного изучения интерактивных материалов.
</details>
